 ...
 *******************************************************************************/
package org.testng.eclipse.internal;
...
import org.testng.eclipse.launch.TestSearchEngine;

/**
 * TestNGPropertyTester provides propertyTester(s) for IResource types
...
public class TestNGPropertyTester extends PropertyTester {
	...
	private static final String PROPERTY_CAN_LAUNCH_AS_TESTNG_TEST= "canLaunchAsTestNG"; //$NON-NLS-1$
	...
	public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
		...
		} else if (PROPERTY_CAN_LAUNCH_AS_TESTNG_TEST.equals(property)) {
